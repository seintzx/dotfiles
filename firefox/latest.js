...
user_pref("browser.firefox-view.view-count", 2); // disable tab manager
user_pref("browser.formfill.enable", true); // DisableFormHistory
...
user_pref("browser.search.suggest.enabled", false); // search suggestion
user_pref("browser.startup.homepage", "chrome://browser/content/blanktab.html");
user_pref("browser.startup.page", 3);
user_pref("browser.tabs.crashReporting.sendReport", false);
user_pref("browser.tabs.firefox-view", false); // disable tab manager
user_pref("browser.tabs.grouping.enabled", true);
...
user_pref("browser.urlbar.suggest.searches", false); // search suggestion
user_pref("browser.urlbar.suggest.topsites", false); // search suggestion
...
user_pref("dom.disable_open_during_load", true); // popup blocker
user_pref("dom.forms.autocomplete.formautofill", false); // CHECK
...
user_pref("extensions.autoDisableScopes", 14); // CHECK
...
user_pref("extensions.pocket.enabled", false); // DisablePocket
