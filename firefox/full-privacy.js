...
user_pref("media.peerconnection.enabled", false); // WebRTC, breaks streaming if disabled
...
user_pref("privacy.resistFingerprinting", true); // resistFingerprinting, breaks stuff if enabled
