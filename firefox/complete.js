...
user_pref("browser.formfill.enable", false); // DisableFormHistory
...
//user_pref("network.http.referer.disallowCrossSiteRelaxingDefault.top_navigation", true); // break calendar event's creation
//user_pref("network.http.referer.spoofSource", true); // break calendar event's creation
user_pref("network.http.speculative-parallel-limit", 0);
user_pref("network.predictor.enable-prefetch", false);
user_pref("network.predictor.enabled", false); // NetworkPrediction
